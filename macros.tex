...
% name aliases
\newcommand{\gribb}{{\color{red}Gribb}}
\newcommand{\daslab}{{\color{red}DasLab}}
\newcommand{\scaleway}{{\color{red}Scaleway}}
\newcommand{\mitserver}{{\color{red}Mit}}
...
\lstdefinestyle{Rust}{%
 ...
 keywords={let,mut,fn,return,pub,struct,where,impl,as,match,not,if,else,loop,while,unsafe,
           default,ref,break,continue,type},
 escapeinside={(*}{*)},
 numbers=none,
 numbersep=5pt,
