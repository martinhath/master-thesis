...
\coderef{MS5}, and its \code{next} pointer \coderef{SM7}.  Since the Michael-Scott queue is always
...
\code{F(T) -> bool}.  Since there is some overhead in declaring a \code{Guard}, \code{Entry}
