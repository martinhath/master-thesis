...
Section~\cref{sec:cmr-overview} gives an overview of the system as a whole, and defines the problem
we want to solve.
Section~\cref{sec:cmr-primitives} defines the primitives of the system, how they interact, and
...
\begin{proof}
  ...
  Using \mc{atomic} (\cref{eq:atomic}), we make sure that the read of $a$ and the store in
