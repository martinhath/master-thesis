...
\egn{use-after-free} is the most hazardous of the three, as program behaviour is often undefined
...
behaviour; POSIXs definition of \code{free} states that it is undefined behaviour to pass a
...
The \egn{Guard} is the only type that CMR defines that are different from conventinal memory
